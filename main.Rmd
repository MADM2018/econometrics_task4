...
## Utilizamos 12 componentes por el Mínimo Error de VC
pls.pred=predict(pls.fit,newdata=x[test,],ncomp=12)
...
## Luego, se contrasta si hay una deterioración del Error de VC al quitar un componente
## del Modelo de PLS, utilizando un alpha = 0.05. Este método utiliza la VC LOOC
